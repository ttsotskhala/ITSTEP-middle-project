...
WORD_CATEGORIES = {
    ...
    "ჯუდო": [
        ...
        "ამოგლეჯილი", "ხაბარელი", "კოკა", "იუკო", "ვაზაარი", "იპონი", "შიდო"
    ],
    "ფიგურული სრიალი": [
...
def play_hangman(category):
    ...
    while True:
        ...
        # მომხმარებლს შეყავს ან ასო ან მთელი სიტყვა
        ...
        if len(guess) > 1:
            if guess in tried_words:
                print("ამ სიტყვის ცდა უკვე გაკეთდა.")
                continue
...
def main():
    ...
    while True:
        ...
        if choice == "0":
            ...
            again = input("გსურთ კიდევ თამაში? (დ/ა): ").strip().lower()
            if again != "დ":
